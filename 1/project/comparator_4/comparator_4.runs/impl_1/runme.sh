...
HD_PWD='D:/BaiduSyncdisk/Repos/verilog-design/1/project/comparator_4/comparator_4.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log comparator_4.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source comparator_4.tcl -notrace
