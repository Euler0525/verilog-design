...
HD_PWD='D:/BaiduSyncdisk/Repos/verilog-design/1/project/comparator_4/comparator_4.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log comparator_4.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source comparator_4.tcl
