...
HD_PWD='D:/BaiduSyncdisk/Repos/verilog-design/1/project/decoder_38/decoder_38.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log decoder_38.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source decoder_38.tcl -notrace
