...
HD_PWD='D:/BaiduSyncdisk/Repos/verilog-design/1/project/decoder_38/decoder_38.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log decoder_38.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source decoder_38.tcl
