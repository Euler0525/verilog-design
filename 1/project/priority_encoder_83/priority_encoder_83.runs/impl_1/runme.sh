...
HD_PWD='D:/BaiduSyncdisk/Repos/verilog-design/1/project/priority_encoder_83/priority_encoder_83.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log priority_encoder_83.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source priority_encoder_83.tcl -notrace
