...
HD_PWD='D:/BaiduSyncdisk/Repos/verilog-design/1/project/priority_encoder_83/priority_encoder_83.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log priority_encoder_83.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source priority_encoder_83.tcl
