...
HD_PWD='D:/BaiduSyncdisk/Repos/verilog-design/1/project/seven_segment_decoder/seven_segment_decoder.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log seven_segment_decoder.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source seven_segment_decoder.tcl -notrace
