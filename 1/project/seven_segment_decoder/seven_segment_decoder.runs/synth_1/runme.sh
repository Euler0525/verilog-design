...
HD_PWD='D:/BaiduSyncdisk/Repos/verilog-design/1/project/seven_segment_decoder/seven_segment_decoder.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log seven_segment_decoder.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source seven_segment_decoder.tcl
