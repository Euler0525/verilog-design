...
HD_PWD='D:/BaiduSyncdisk/Repos/verilog-design/2/project/multifunction/multifunction.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log multifunction.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source multifunction.tcl -notrace
