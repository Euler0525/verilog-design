...
HD_PWD='D:/BaiduSyncdisk/Repos/verilog-design/2/project/multifunction/multifunction.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log multifunction.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source multifunction.tcl
