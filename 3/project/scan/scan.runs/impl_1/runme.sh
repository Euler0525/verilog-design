...
HD_PWD='D:/BaiduSyncdisk/Repos/verilog-design/3/project/scan/scan.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log scan_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source scan_top.tcl -notrace
