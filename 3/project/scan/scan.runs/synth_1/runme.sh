...
HD_PWD='D:/BaiduSyncdisk/Repos/verilog-design/3/project/scan/scan.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log scan_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source scan_top.tcl
